    ...
    <x-slot name="slotMain">
        <section id="editResource" class="get-started section-bg">
            <div class="col-lg-5" data-aos="fade">
                <form action="{{ route('carousels.store') }}" class="php-email-form" method="POST" enctype="multipart/form-data">
                    @csrf
                    <h3>Creating a new Carousel</h3>
                    <p>Fill in the details for the new Carousel.</p>
                    <div class="row gy-3">
                        ...
                        <div class="col-md-12 text-center">
                            ...
                            <div class="sent-message">The Carousel has been successfully created. Thank you!</div>
